...
public class MarkovAdapter extends RecyclerView.Adapter<MarkovAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            v.setOnLongClickListener(new View.OnLongClickListener() {
                /**
                 * Called when our parameter's {@code View view} has been long clicked. First we initialize
                 * our variable {@code String possibles} with the string value of our field {@code MarkovStats markovStats},
                 * initialize our variable {@code String verse} with the text in our field {@code TextView textView}, and
                 * initialize our variable {@code MarkovDialog markovDialog} with a new instance constructed to display
                 * {@code possibles} and {@code verse}. We initialize {@code FragmentTransaction ft} by using the
                 * {@code MarkovAdapter} static field {@code FragmentManager mFragmentManager} to begin a transaction,
                 * and initialize {@code Fragment prev} by using it to find a fragment with the tag "dialog". If {@code prev}
                 * is not null we use {@code ft} to remove it, then use it to add null to the backstack. Finally we call the
                 * {@code show} method of {@code markovDialog} to have it use {@code ft} to display the dialog, adding the
                 * fragment to {@code ft} and then committing the transaction. Finally we return true to consume the event here.
                 *
     ...
     * set the text in {@code ViewHolder holder} to the sentence of random nonsense generated by
     * calling the {@code line} method of the {@code MarkovAdapter} field {@code Markov mMarkov}.
     *
